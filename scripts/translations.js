...
const translations = {
  ja: {
    ...
    heroSubtitle:
      "あなたのビジネスアイデアを説明するだけで、プロフェッショナルなWebサイトが完成。コーディング不要、技術知識不要。",
    btnTryDemo: "無料で試す",
    btnViewDemo: "デモを見る",
    ...
    step1Title: "ビジネスを説明",
    step1Desc:
      "あなたのビジネスや目的を簡単に説明してください。AIが内容を理解します。",
    step2Title: "スタイルを選択",
    step2Desc:
      "複数のプロフェッショナルなテーマから、お好みのデザインを選んでください。",
    step3Title: "即座に生成",
    ...
    feature1Desc:
      "最先端のAI技術により、コンテンツとデザインを自動生成。プロフェッショナルな仕上がりを保証。",
    feature2Title: "多言語対応",
    feature2Desc:
      "日本語、英語、スペイン語など、複数の言語でWebサイトを自動生成。グローバル展開も簡単。",
    feature3Title: "完全レスポンシブ",
    feature3Desc:
      "スマートフォン、タブレット、PCなど、すべてのデバイスで最適表示。",
    feature4Title: "高速パフォーマンス",
    feature4Desc:
      "最適化されたコードで、読み込み速度が速く、SEOにも強いWebサイトを生成。",
    feature5Title: "多彩なテーマ",
    feature5Desc:
      "モダン、ミニマル、エレガントなど、5種類以上のプロフェッショナルテーマから選択可能。",
    feature6Title: "安全・セキュア",
    feature6Desc:
      "最新のセキュリティ対策を実装。お客様のデータを確実に保護します。",
    ctaTitle: "今すぐ始めましょう",
    ...
    formTitle: "Webサイトを生成",
    companyName: "会社名",
    companyPlaceholder: "会社名またはプロジェクト名...",
  ...
  en: {
    ...
    heroSubtitle:
      "Simply describe your business idea and get a professional website. No coding required, no technical knowledge needed.",
    ...
    step1Desc:
      "Simply describe your business or purpose. AI will understand the content.",
    step2Title: "Choose a Style",
    step2Desc:
      "Select your preferred design from multiple professional themes.",
    step3Title: "Generate Instantly",
    step3Desc:
      "AI automatically generates a complete website. Ready to publish immediately.",
    featuresTitle: "Powerful Features",
    featuresSubtitle: "Features to drive your business success",
    feature1Title: "AI-Powered Generation",
    feature1Desc:
      "Automatically generate content and design with cutting-edge AI technology. Professional results guaranteed.",
    feature2Title: "Multilingual Support",
    feature2Desc:
      "Automatically generate websites in multiple languages including Japanese, English, and Spanish. Easy global expansion.",
    feature3Title: "Fully Responsive",
    feature3Desc:
      "Optimal display on all devices including smartphones, tablets, and PCs.",
    feature4Title: "High Performance",
    feature4Desc:
      "Optimized code for fast loading speeds and strong SEO performance.",
    feature5Title: "Diverse Themes",
    feature5Desc:
      "Choose from over 5 professional themes including Modern, Minimal, and Elegant.",
    feature6Title: "Safe & Secure",
    feature6Desc:
      "Latest security measures implemented. Your data is securely protected.",
    ...
    contactHours: "🕐 Hours",
    contactHoursText:
      "Monday - Friday: 9:00 - 18:00<br>Saturday: 10:00 - 14:00",
  ...
  es: {
    ...
    heroSubtitle:
      "Simplemente describe tu idea de negocio y obtén un sitio web profesional. Sin programación requerida, sin conocimientos técnicos necesarios.",
    ...
    step1Desc:
      "Simplemente describe tu negocio o propósito. La IA comprenderá el contenido.",
    step2Title: "Elige un Estilo",
    step2Desc:
      "Selecciona tu diseño preferido de múltiples temas profesionales.",
    step3Title: "Genera Instantáneamente",
    step3Desc:
      "La IA genera automáticamente un sitio web completo. Listo para publicar inmediatamente.",
    ...
    feature1Desc:
      "Genera contenido y diseño automáticamente con tecnología de IA de vanguardia. Resultados profesionales garantizados.",
    feature2Title: "Soporte Multiidioma",
    feature2Desc:
      "Genera sitios web automáticamente en múltiples idiomas incluyendo japonés, inglés y español. Expansión global fácil.",
    feature3Title: "Totalmente Responsive",
    feature3Desc:
      "Visualización óptima en todos los dispositivos incluyendo smartphones, tablets y PCs.",
    feature4Title: "Alto Rendimiento",
    feature4Desc:
      "Código optimizado para velocidades de carga rápidas y fuerte rendimiento SEO.",
    feature5Title: "Temas Diversos",
    feature5Desc:
      "Elige entre más de 5 temas profesionales incluyendo Moderno, Minimalista y Elegante.",
    feature6Title: "Seguro y Protegido",
    feature6Desc:
      "Últimas medidas de seguridad implementadas. Tus datos están protegidos de forma segura.",
